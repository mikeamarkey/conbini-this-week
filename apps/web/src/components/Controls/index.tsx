...
export default function Controls({
  ...
  return (
    <div className="m-auto max-w-lg">
      <input
        className="w-full rounded-xl border-2 border-gray-300 px-4 py-2 outline-none transition-colors hover:border-gray-900 focus:border-gray-900 active:border-gray-900"
        type="search"
        aria-label="search"
